    ...
    public class ElectricityBox : Activator
    {
        ...
        public override void Activate()
        {
            ...
            if (ActivableElement != null)
            {
                ...
                {
                    scene.SoundManager.ISoundEngine.Play3D(scene.SoundManager.ElecBoxOn, body.Position.X, body.Position.Y, 0f, false, false, false);
                }
                else
                {
                    scene.SoundManager.ISoundEngine.Play3D(scene.SoundManager.ElecBoxOff, body.Position.X, body.Position.Y, 0f, false, false, false);
                }
            }
        }
