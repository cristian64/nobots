...
namespace Nobots.ParticleSystem
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        /// Constructor.
        /// </summary>
        protected ParticleSystem(Game game, Scene scene)
            : base(game)
        {
        ...
        {
            Effect effect = content.Load<Effect>("particlesystem\\ParticleEffect");
            ...
            Texture2D texture = content.Load<Texture2D>("particlesystem\\" + settings.TextureName);
