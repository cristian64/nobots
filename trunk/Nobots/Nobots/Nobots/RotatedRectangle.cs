...
namespace RotatedRectangleCollisions
{
    ...
    public class RotatedRectangle
    {
        ...
        public RotatedRectangle(RectangleF theRectangle, float theInitialRotation)
        {
        ...
        /// <returns></returns>
        public bool Intersects(RectangleF theRectangle)
        {
            return Intersects(new RotatedRectangle(theRectangle, 0.0f));
        }

        public bool Intersects(RectangleF theRectangle, float rotation)
        {
            return Intersects(new RotatedRectangle(theRectangle, rotation));
        }
